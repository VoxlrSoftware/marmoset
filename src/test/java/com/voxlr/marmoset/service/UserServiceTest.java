...
public class UserServiceTest extends DataTest {
  ...
  public void beforeTest() {
    ...
    mockUser.setEmail("test.user@test.com").setPassword(bCryptPasswordEncoder.encode("Password"));
  ...
  public void createShouldReturnUserForCompanyAdmin() throws Exception {
    AuthUser authUser = createAuthUser(UserRole.COMPANY_ADMIN).setCompanyId(company.getId());
  ...
  public void createHigherUserShouldFailForCompanyAdmin() throws Exception {
    ...
    List<UserRole> roles = listOf(UserRole.SUPER_ADMIN, UserRole.ADMIN);
  ...
  public void createShouldReplaceCompanyAndTeamIdForCompanyAdmin() throws Exception {
    AuthUser authUser =
        createAuthUser(UserRole.TEAM_ADMIN).setCompanyId(company.getId()).setTeamId(team.getId());
  ...
  public void createShouldReturnUserForTeamAdmin() throws Exception {
    ...
    List<UserRole> roles = listOf(UserRole.TEAM_ADMIN, UserRole.TEAM_READONLY, UserRole.MEMBER);
                  ...
                  () -> {
                    ...
                    assertThat(
                        bCryptPasswordEncoder.matches(
                            userUpdateDTO.getPassword(), user.getPassword()),
                        is(true));
                  });
            });
  }

...
public class EntityTestUtils {
  ...
  public static CallStrategy createCallStrategy(String name, List<String> phrases) {
    CallStrategy callStrategy = CallStrategy.builder().phrases(phrases).build();
  ...
  public static Company createCompany(String name, String... phrases) {
    CompanyBuilder builder = Company.builder().name(name);
  ...
  public static AuthUser createAuthUser(UserRole role) {
    User user =
        createAuditableEntity(
            User.builder().email("test@test.com").password("Password").role(role).build());

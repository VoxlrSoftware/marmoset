...
public class UserCreateValidator implements Validator<UserCreateDTO> {
  ...
  public void validate(AuthUser authUser, UserCreateDTO entity) throws Exception {
    userCompanyValidationHandler.validate(authUser, entity::getCompanyId, entity::setCompanyId);
    userTeamValidationHandler.validate(authUser, entity::getTeamId, entity::setTeamId);

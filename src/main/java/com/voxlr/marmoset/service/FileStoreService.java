...
public class FileStoreService {
  ...
  private final Pattern pattern =
      Pattern.compile("^.*\\/(voxlr\\-store(\\/[a-zA-Z\\-]+)+)\\/([a-zA-Z0-9\\_]+\\.\\w+)$");
  ...
  public String uploadString(
      String content, String key, String bucketName, ObjectMetadata objectMetadata)
      throws Exception {
    InputStream inputStream = null;
    try {
  ...
  public String uploadStream(InputStream inputStream, String key, String bucketName)
      throws Exception {
    return uploadStream(inputStream, key, bucketName, new ObjectMetadata());
  }

  public String uploadStream(
      InputStream inputStream, String key, String bucketName, ObjectMetadata objectMetadata)
      throws Exception {
    try {

...
public class CompanyService {
  ...
  public CallStrategy findCallStrategy(String companyId, String strategyId)
    ...
    Optional<CallStrategy> strategy =
        company.getCallStrategies().stream().filter(x -> x.getId().equals(strategyId)).findFirst();
  ...
  public Company update(CompanyUpdateDTO companyUpdateDTO, AuthUser authUser)
      throws EntityNotFoundException {
              ...
              strategyDTO -> {
                ...
                if (strategyDTO.getId() != null) {
                  Optional<CallStrategy> currentStrategy =
                      currentStrategies
                          .stream()
                          .filter(x -> x.getId().equals(strategyDTO.getId()))
                          .findFirst();

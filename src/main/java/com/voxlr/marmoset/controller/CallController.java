...
public class CallController extends ApiController {
  ...
  public ResponseEntity<?> averageCallsByCompany(
    ...
    RollupResultDTO result =
        callService.averageCallsByCompanyId(companyId, authUser, dateConstrained, fields);
  ...
  public ResponseEntity<?> rollupCallsByCompany(
    ...
    List<RollupResultDTO> result =
        callService.rollupCallsByCompanyId(companyId, authUser, dateConstrained, cadence, fields);
  ...
  public ResponseEntity<?> getCallsByUser(
    ...
    DateConstrained dateConstrained =
        DateConstrained.builder().startDate(startDate).endDate(endDate).build();
    Page<CallAggregateDTO> results =
        callService.getCallsByUserId(userId, authUser, dateConstrained, fields, page(pageable));
    PageDTO<CallAggregateDTO> mappedResults = mapperUtils.mapPage(results);
    return new ResponseEntity<PageDTO<CallAggregateDTO>>(mappedResults, HttpStatus.OK);
  }
  ...
  public ResponseEntity<?> averageCallsByUser(
    ...
    DateConstrained dateConstrained =
        DateConstrained.builder().startDate(startDate).endDate(endDate).build();
    RollupResultDTO result =
        callService.averageCallsByUserId(userId, authUser, dateConstrained, fields);
    return new ResponseEntity<RollupResultDTO>(result, HttpStatus.OK);
  }
  ...
  public ResponseEntity<?> rollupCallsByUser(
    ...
    DateConstrained dateConstrained =
        DateConstrained.builder().startDate(startDate).endDate(endDate).build();
    List<RollupResultDTO> result =
        callService.rollupCallsByUserId(userId, authUser, dateConstrained, cadence, fields);
    return new ResponseEntity<List<RollupResultDTO>>(result, HttpStatus.OK);
  }
}

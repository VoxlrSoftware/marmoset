...
public class AnnotationUtils {
  ...
  public static Set<Class<?>> getAnnotatedClasses(String packageName, Class annotationClass) {
  ...
  public static <T> HashMap<String, Object> getAnnotationMembers(
      Class annotatedClass, Class annotationClass) {
            ...
            method -> {
              try {
                ...
                throw new RuntimeException(
                    "Invalid method name for annotatedClass [" + annotatedClass.getName() + "].");
              }
            });

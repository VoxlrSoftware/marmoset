...
public class VoxlrAnalysis extends CallbackHandler<String> {
  ...
  @Autowired private CallAnalysisService callAnalysisService;
  ...
  public CallbackResult<String> handleRequest(String requestPath, CallbackBody callbackBody)
    ...
    try {
      CallAnalysisResult result =
          objectMapper.convertValue(callbackBody.getJsonBody(), CallAnalysisResult.class);
